/*
# DEL AI — Seed Data Recovery

## Summary
Restores the original seed data from the project's seed migration:
- 3 sample events (AI Leadership Summit, Cloud & Cybersecurity Forum, CIO Forum)
- 8 realistic Philippine market executive contacts
- 12 persona facts for 2 contacts (Maria Santos, Eduardo Tan)
- 9 event scores across contacts/events
- 2 final attendee markers
...
-- Persona facts for Maria Santos
